...
- **Target + needs:** Nottingham independents, niche services. Needs map + good-lead gift rule (score ≥7 → 2 free custom 3D prints): `prompts/maz-works-niche-needs.md`.
...
For each lead capture: name, site URL, Google rating + review count, the ONE specific leak you can see (e.g. no booking link on mobile, contact form 404s, no reviews link, menu is a PDF, site not HTTPS), evidence (URL + what you saw), best-fit offer, good-lead score 0–10 (prompts/maz-works-niche-needs.md), gift-eligible (≥7).
